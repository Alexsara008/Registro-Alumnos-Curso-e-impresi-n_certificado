...
if($_POST){
  ...
  // voy a recepcionar lo que es usuario y contrasena
  // si tiene esos dos valor o input me va a inicializar 
  // una variable que diga usuario con el valor que me llega
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <!-- vamos a poner una condicional -->
                      <!-- imprimimos el mensaje con una lerta  -->
